...
subset_select <- function(dat){
  ...
  featsel_boruta <-Boruta(x=dat[,2:ncol(dat)], y=dat$labels, doTrace=2, ntree=1000)
...
save.image("Z:/Cristina/Section3/paper_notes/comparison_traditionalCAD/traditionalCADperf.RData")
}
